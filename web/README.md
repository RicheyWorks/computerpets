...
- `/demo/{slug}` — a room. The guest is already walking. The extra shows the Mac sit. The mark shows the Linux sit. Every species (rui, miso, pip, thimble, … ember, cup, felt, comb, frill, gleam, boot).
