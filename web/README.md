...
Opens the desk. Guests get Rui immediately. Signed-in keepers can hatch and care through the kennel. The kennel is a room. The cards stay paper. The shelf is a room. The hundred and forty sit by den, not by rarity.
...
- `/catalog` — a room. The hundred and forty sit by den, not by rarity.
- `/meet` — house landing
