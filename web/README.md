...
- `/demo/{slug}` — a room. The guest is already walking. The extra shows the Mac sit. The mark shows the Linux sit. The sit shows the tablet sit. Every species (rui, miso, pip, thimble, … ember, cup, felt, comb, frill, gleam, boot).
