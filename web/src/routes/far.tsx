    ...
    <main className="bg-bg text-fg">
      <section className="relative isolate min-h-[58dvh] overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[58dvh] max-w-5xl flex-col justify-end px-5 pb-12 pt-28 sm:px-8">
          <p className="text-[11px] uppercase tracking-[0.22em] text-subtle">The far den</p>
          ...
          <p className="mt-5 max-w-lg text-base text-muted sm:text-lg">
            Ten guests that never evolved here live on this blotter. Watch the hover. Read the
            plaque. Leave knowing a thirst is a wavelength, a colony can be one name, and most of a
            life can be the wait.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <Button asChild>
              <Link to="/demo/$slug" params={{ slug: "gleam" }}>
                Watch Gleam
              </Link>
            </Button>
