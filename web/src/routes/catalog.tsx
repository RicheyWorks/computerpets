...
export const Route = createFileRoute("/catalog")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "The shelf is a room. The two hundred ten sit by den, not by rarity.",
      },
    ],
  }),
});
    ...
    <CompanionRoom
      ...
      line={
        <p className="mt-3 max-w-sm text-sm text-muted">
          The shelf is a room. The two hundred ten sit by den, not by rarity. Open a room, or pick a name.
        </p>
      }
      aside={
        <div className="mt-5 max-h-[calc(100dvh-16rem)] max-w-sm space-y-3 overflow-y-auto pr-1">
          <aside className="paper-card rounded-[var(--radius-lg)] border p-4">
            ...
            <h2 className="mt-1 font-display text-2xl">The two hundred ten.</h2>
            <p className="mt-2 text-sm text-muted">
              Two hundred ten guests, on their shelves. By den, not by rarity. They will be walking when the page opens.
            </p>
          </aside>
