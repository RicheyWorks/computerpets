      ...
      <section className="mx-auto max-w-5xl px-5 py-16 sm:px-8 sm:py-20">
        <div className="flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 font-display text-3xl sm:text-4xl">Eighty living demos.</h2>
            <p className="mt-2 max-w-md text-sm text-muted">
              ...
              keeps the fungi. The far den keeps the guests that never evolved here.
            </p>
          </div>
          <div className="hidden flex-col items-end gap-1 sm:flex">
            ...
            <Link to="/far" className="text-sm text-muted no-underline hover:text-fg">
              The far den
            </Link>
        ...
        <div className="mx-auto max-w-5xl px-5 py-14 sm:px-8">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            ...
            <article className="rounded-[var(--radius-lg)] border border-border bg-surface p-5">
              ...
              <p className="mt-2 text-sm text-muted">
                Open Live, then Add to Home Screen. Tap the blotter for a treat. Chase the ribbon. All eighty.
              </p>
              <p className="mt-3">
