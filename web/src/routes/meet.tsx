  ...
  head: () => ({
    meta: [
      { title: "Meet the house — ComputerPets" },
      {
        name: "description",
        content:
          "One hundred thirty living companions walk the blotter. The nest is a square; neglect can close a line.",
      },
    ],
  }),
});
  ...
  return (
    <main className="bg-bg text-fg">
      <section className="relative isolate min-h-[92dvh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[92dvh] max-w-5xl flex-col justify-end px-5 pb-12 pt-28 sm:px-8">
          ...
          <p className="mt-5 max-w-md text-base text-muted sm:text-lg">
            One hundred thirty guests walk the blotter. The nest is a square; neglect can close a line.
          </p>
      ...
      <section className="mx-auto max-w-5xl px-5 py-16 sm:px-8 sm:py-20">
        ...
        <h2 className="mt-2 font-display text-3xl sm:text-4xl">One hundred thirty, on their shelves.</h2>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            <article className="rounded-[var(--radius-lg)] border border-border bg-surface p-5">
              ...
              <p className="mt-2 text-sm text-muted">
                Transparent overlay. Treat, chase, hide. They walk the real screen. All one hundred thirty.
              </p>
