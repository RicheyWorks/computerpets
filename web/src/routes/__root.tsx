...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      { name: "description", content: "One hundred ten living desk companions, including ten snakes, a tide of ten sea creatures, a garden of ten plants, a hive of bees and comb, a pond of ten Animalia, a cellar of ten fungi, a well of ten leftovers, and a far den of ten guests that never evolved here. They walk, talk, and wait in the browser." },
