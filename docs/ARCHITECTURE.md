...
| Field            | Value                                      |
|------------------|--------------------------------------------|
| **Last Updated** | 2026-08-18 (cellar den: ten fungi) |
| **Version**      | 1.1                                        |
...
| `PetCatalog` / `PetType` | Static catalog of 70 living kinds across 4 rarity tiers; lookup + grouping utilities   | Java enum + Spring @Service | `pet/PetType.java`, `pet/PetCatalog.java` | —                                |
