...
| **[Desktop companion](../desktop/README.md)** | Native overlay — all two hundred ten living kinds, plus the first client-contract unlock slice. |
| **[PyQt blotter](../client/README.md)** | PyQt6 desk — all two hundred ten, plaques, house weather / visitor / shed, mess / illness, Qt OpenGL viewport, same contract unlock. |
