...
| **[Desktop companion](../desktop/README.md)** | Native overlay — all forty pets, plus the first client-contract unlock slice. |
| **[PyQt blotter](../client/README.md)** | PyQt6 desk — all forty, plaques, house weather / visitor / shed, mess / illness, Qt OpenGL viewport, same contract unlock. |
