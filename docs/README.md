...
| **[Desktop companion](../desktop/README.md)** | Native overlay — all one hundred thirty living kinds, plus the first client-contract unlock slice. |
| **[PyQt blotter](../client/README.md)** | PyQt6 desk — all one hundred thirty, plaques, house weather / visitor / shed, mess / illness, Qt OpenGL viewport, same contract unlock. |
