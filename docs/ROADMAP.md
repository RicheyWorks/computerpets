...
- [x] Full catalog awake — all one hundred thirty living kinds have living browser demos
- [x] Windows/Mac desktop overlay for all one hundred thirty + phone/tablet Live companion
- [x] Backend `PetType` catalog matches the living desk (ten snakes, a tide of ten sea creatures, a garden of ten plants, a hive of insects plus bees and comb, a pond of ten Animalia, a roost of ten birds, a corner of ten arachnids and their neighbors, a cellar of ten fungi, a well of ten leftovers, and a far den of ten xenobiology guests licensed)
