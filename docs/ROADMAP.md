...
- [x] Full catalog awake — all one hundred ten living kinds have living browser demos
- [x] Windows/Mac desktop overlay for all one hundred ten + phone/tablet Live companion
