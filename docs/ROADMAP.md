...
- [x] Full catalog awake — all one hundred eighty living kinds have living browser demos
- [x] Windows/Mac desktop overlay for all one hundred eighty + phone/tablet Live companion
