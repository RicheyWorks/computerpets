...
- [x] Full catalog awake — all one hundred ninety living kinds have living browser demos
- [x] Windows/Mac desktop overlay for all one hundred ninety + phone/tablet Live companion
