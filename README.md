...
A living ecology. A natural-history house. One hundred sixty guests walk the blotter.
...
The house nav is **Desk**, **Live**, and **Meet**. Then the dens: `/study`, `/snakes`, `/sea`, `/garden`, `/hive`, `/pond`, `/roost`, `/corner`, `/wood`, `/stone`, `/creek`, `/cellar`, `/well`, `/far`. On a phone, open **Live** and Add to Home Screen.
...
Sign in. The hatch is a room. The draw lands you with the guest. The kennel is a room. The cards stay paper. The shelf is a room. The hundred and sixty sit by den, not by rarity.
